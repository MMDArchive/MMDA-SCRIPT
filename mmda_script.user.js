...
(function () {
        ...
        CreateConsole: () => {
            if ($("#console").length <= 0) {
                ...
                consoleClose.addEventListener("click", () => {
                    MMDStorage.Remove("keepConsoleOpen");
                    MMDConsole.Close();
                });
    ...
    if (MMDStorage.Get("keepConsoleOpen") === "true") {
    ...
    document.addEventListener("keydown", (e) => {
        if (e.ctrlKey && e.key == "l") {
            e.preventDefault();
            if (MMDStorage.Get("keepConsoleOpen") == "true") {
                MMDStorage.Set("keepConsoleOpen", "false");
                MMDConsole.Close();
            } else {
                MMDStorage.Set("keepConsoleOpen", "true");
                MMDConsole.CreateConsole();
            }
        }
    });
    ...
    if (window.location.href === "https://mmda.booru.org/index.php?page=account-options") {
        ...
        if (container) {
            // create row with label and checkbox
    ...
    if (window.location.href.startsWith("https://mmda.booru.org/index.php?page=post&s=view&id=")) {
        ...
        MMDConsole.Log(`[${MMDConsole.Colorize("green", "UI")}] Tags are now linked to their respective links. Lorem ipsum dolor sit amet, consectetur adipiscing elit.`);
